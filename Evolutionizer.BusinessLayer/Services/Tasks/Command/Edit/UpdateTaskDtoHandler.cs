...
{
    public class UpdateTaskDtoHandler : IRequestHandler<UpdateTaskDto, TaskViewModel>
    {
        private readonly IRepository _repository;
        private readonly IMapper _mapper;
        public UpdateTaskDtoHandler(IRepository repository, IMapper mapper)
        {
            _repository = repository;
            _mapper = mapper;
        }
        public async Task<TaskViewModel> Handle(UpdateTaskDto request, CancellationToken cancellationToken)
        {
            ...
            taskEntity.UpdateTask(request.Name, request.Description);
